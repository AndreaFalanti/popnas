...
class PredictorsHandler:
    ...
    def __init__(self, search_space: SearchSpace,
                 score_metric: str, score_domain: 'tuple[float, float]',
        ...
        Args:
            ...
            score_metric: the score metric specified in the POPNAS JSON configuration file.
        ...
        score_csv_field = metrics_fields_dict[score_metric].real_column
